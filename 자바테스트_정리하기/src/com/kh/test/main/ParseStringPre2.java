...
public class ParseStringPre2 {
	public static void main(String[] args) {
		...
		System.out.println("하이픈이 제거된 주민등록전호 : " + 주민번호);
		
		
		//charAt(7)
		//주민등ㄹ고 번호에서 하이픈을 제거하고 성별을 추출하기
		...
		//주민번호가 앞자리는 6자리가 맞는지 확인하고 뒤에는 7자리가 맞는지 확인
